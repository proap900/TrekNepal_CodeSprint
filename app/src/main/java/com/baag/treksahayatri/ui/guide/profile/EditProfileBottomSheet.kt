package com.baag.treksahayatri.ui.traveller.ui.Profile
...
class EditProfileBottomSheet : BottomSheetDialogFragment() {
		...
		firestore.collection("guideprofile").document(uid).get()
			.addOnSuccessListener { doc ->
				...
				guide?.let {
					...
					binding.etGuidePlaces.setText(it.guidingPlaces)
	...
	private fun updateUser(
		...
		firestore.collection("guideprofile").document(uid).set(data)
