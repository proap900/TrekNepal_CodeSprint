package com.baag.treksahayatri.ui.traveller
...
import com.baag.treksahayatri.databinding.ActivityTravellerMainBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore
import com.google.firebase.storage.FirebaseStorage
import java.util.UUID

class TravellerMainActivity : AppCompatActivity() {
    private lateinit var binding: ActivityTravellerMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTravellerMainBinding.inflate(layoutInflater)
        ...
        val navHostFragment = supportFragmentManager
            .findFragmentById(R.id.nav_host_fragment_activity_main_traveller) as NavHostFragment
        navController = navHostFragment.navController

        // Setup custom bottom navigation clicks
        binding.navHome.setOnClickListener {
            safeNavigate(R.id.nav_home)
        }
    ...
    private fun uploadMedia(uri: Uri, mediaType: String) {
        val path = "traveller_media/$currentUserId/${mediaType}s/${UUID.randomUUID()}"
        ...
        ref.putFile(uri)
            ...
            .addOnSuccessListener { downloadUri ->
                ...
                firestore.collection("traveller_media").document(currentUserId)
                    .collection("items")
                    .add(media)
            }
